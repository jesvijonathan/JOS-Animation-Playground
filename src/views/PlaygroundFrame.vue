      ...
      <div class="opt">
        <div class="opt_inside">
          ...
          <select name="animation" id="animation" v-model="option.animation">
            ...
            <option value="skew-left">skew-left</option>
            <option value="skew-right">skew-right</option>
            <option value="skew-down">skew-down</option>
            <option value="skew-up">skew-up</option>
            ...
            <option value="bar_horizontal">bar_horizontal</option>
      ...
      <div class="opt">
        <div class="opt_inside">
          ...
          <select name="version" id="version" v-model="version">
            ...
            <option value="0.9.0" disabled>0.9.0</option>

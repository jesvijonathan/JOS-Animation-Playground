<template>
  ...
  <ul>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to JOS Animation, accessible from
        <a
          href="https://jos-animation.vercel.app"
          rel="external nofollow noopener"
          target="_blank"
          >https://jos-animation.vercel.app</a
        >
      </p>
    </li>
    <li>
  ...
  <ul>
    <li>
      ...
      <a
        href="https://jos-animation.vercel.app/jesvi22j@gmail.com"
        rel="external nofollow noopener"
        target="_blank"
        >https://jos-animation.vercel.app/jesvi22j@gmail.com</a
      >
    </li>
  </ul>
</template>
